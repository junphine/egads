 ...
 * 
 */
package jsatfx.fastdtw.timeseries;
...
public class TimeSeriesPoint {
    ...
    public TimeSeriesPoint(double values[]) {
        ...
        for (int x = 0; x < values.length; x++) {
            hashCode += Double.hashCode(values[x]);
    ...
    public TimeSeriesPoint(Collection<? extends Number> values) {
        ...
        for (int index = 0; i.hasNext(); index++) {
            ...
            hashCode += Double.hashCode(measurements[index]);
        }
    ...
    public void set(int dimension, double newValue) {
        hashCode -= Double.hashCode(measurements[dimension]);
        measurements[dimension] = newValue;
        hashCode += Double.hashCode(newValue);
    }
