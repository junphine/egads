...
public abstract class AbstractBuilder implements Builder
{
    ...
    public String getDependentVariableName(){
    	if(dependentVariableName==null){
    		return getVariableName(n);
    	}
     ...
     */
    protected int getDependentVariable() {    	
    	if(dependentVariableName==null){
    		return n;
    	}
    	int d = varName.indexOf(this.dependentVariableName);
    	if(d >= 0){
    		return d;
    	}
    	throw new IndexOutOfBoundsException("getDependentVariable() called with only "+dependentVariableName
                                  +" variables defined");
    }
